...
import sqlite3
import pandas as pd
con = sqlite3.connect("now-sample-db")
engine = create_engine('sqlite:///now-sample-db.db')
engine.connect()
# 2) Execute the SQL sentences to create your tables using the SQLAlchemy's execute function
database_url = 'sqlite:///now-sample-db'
engine.execute("""
...
df_books = pd.read_sql(SELECT * books, engine)
print(df_books)